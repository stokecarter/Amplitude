...
class CommonFunctions {
    ...
    static func actionOnTags(_ id: String, name: String, action:Bool, completion:@escaping(()->())){
        if action{
            Amplitude.instance().logEvent("Save Tag", withEventProperties: ["Tag Name": name])
    ...
    static func navigateToUserProfile(_ id:String,onParent:UIViewController? = nil){
        if id == UserModel.main.userId{
            ...
            Amplitude.instance().logEvent("View Other User Profile")
    ...
    static func setUserProperties(user: UserProfileModel) {
        ...
        let identify = AMPIdentify()
            .set("User Type", value: (user.isGuestAccount ? "guest user": "profile user") as NSObject)
            .set("Following Count", value: NSNumber(value: user.followingCount))
            .set("Follower Count", value: NSNumber(value: user.followersCount))
            .set("Push Notification Status", value: (isRegisteredForRemoteNotifications ? "allowed": "not allowed") as NSObject)
            .set("App Install Date", value: "\(installDate ?? "")" as NSObject)
            .setOnce("Sign Up Date", value: user.updatedCreatedAt as NSObject)
            .set("Profile Picture", value: (user.profilePicture.isEmpty ? "no": "yes") as NSObject)
            .set("No. Of Comments", value: NSNumber(value: user.noOfComment))
        
        identify?
            .set("No. Of Comment reactions sent", value: NSNumber(value: user.noOfCommentReactionSent))
            .set("No. Of Likes", value: NSNumber(value: user.like))
            .set("No. Of Dislikes", value: NSNumber(value: user.dislike))
            .set("No. Of Exclamations", value: NSNumber(value: user.clap))
            .set("No. Of Laughs", value: NSNumber(value: user.laugh))
            .set("No. Rooms Joined", value: NSNumber(value: user.noOfRoomJoined))
            .set("No. Rooms Saved", value: NSNumber(value: user.noOfRoomJoined))
            .set("Username", value: user.userName as NSObject)
            
        identify?
            .set("No. Of Tags Saved", value: NSNumber(value: user.noOfSavedTag))
            .set("Bio", value: (user.bio.isEmpty ? "no": "yes") as NSObject)
            .set("No. Of Hot Takes Posted", value: NSNumber(value: user.noOfHotTakePost))
            .set("No. Upvotes Received", value: NSNumber(value: user.noOfUpvoteReceived))
            .set("No. Downvotes Received", value: NSNumber(value: user.noOfDownvoteReceived))
            .set("No. Of upvotes Given", value: NSNumber(value: user.noOfUpvoteGiven))
            .set("No. Of Downvotes Given", value: NSNumber(value: user.noOfDownVoteGiven))
