...
class DiscoverVC: BaseVC {
    ...
    @IBAction func openSearchVC(_ sender: Any) {
        Amplitude.instance().logEvent("View Search")
...
extension DiscoverVC : UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            case 0:
                ...
                cell.btnAction = { [weak self] in
                    Amplitude.instance().logEvent("View All Categories")
        ...
        case 1:
            ...
            case 0:
                ...
                cell.btnAction = { [weak self] in
                    Amplitude.instance().logEvent("View Leaderboards")
        ...
        default:
            ...
            case 0:
                ...
                cell.btnAction = { [weak self] in
                    Amplitude.instance().logEvent("View Today's Events")
                    self?.perfornBtnAction(indexPath.section)
                }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.section == 2 && indexPath.row != 0{
            ...
            Amplitude.instance().logEvent("View Event", withEventProperties: ["Event Name": "\(viewModel.events[indexPath.row - 1].name)"])
            AppRouter.pushViewController(self, vc)
