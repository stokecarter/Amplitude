...
struct UserProfileModel{
    ...
    var noOfComment: Int
    var noOfRoomJoined: Int
    var noOfHotTakePost: Int
    var noOfUpvoteGiven: Int
    var updatedCreatedAt: Int
    var noOfDownVoteGiven: Int
    var noOfUpvoteReceived: Int
    var noOfDownvoteReceived: Int
    var noOfCommentReactionSent: Int
    var noOfSavedTag: Int
    ...
    init(_ json:JSON) {
        ...
        noOfComment = json["noOfComment"].intValue
        noOfRoomJoined = json["noOfRoomJoined"].intValue
        noOfHotTakePost = json["noOfHotTakePost"].intValue
        noOfUpvoteGiven = json["noOfUpvoteGiven"].intValue
        updatedCreatedAt = json["updatedCreatedAt"].intValue
        noOfDownVoteGiven = json["noOfDownVoteGiven"].intValue
        noOfUpvoteReceived = json["noOfUpvoteReceived"].intValue
        noOfDownvoteReceived = json["noOfDownvoteReceived"].intValue
        noOfCommentReactionSent = json["noOfCommentReactionSent"].intValue
        noOfSavedTag = json["noOfSavedTag"].intValue
    }
    ...
    init(withDB u:UserProfileDBM){
        ...
        noOfComment = u.noOfComment
        noOfRoomJoined = u.noOfRoomJoined
        noOfHotTakePost = u.noOfHotTakePost
        noOfUpvoteGiven = u.noOfUpvoteGiven
        updatedCreatedAt = u.updatedCreatedAt
        noOfDownVoteGiven = u.noOfDownVoteGiven
        noOfUpvoteReceived = u.noOfUpvoteReceived
        noOfDownvoteReceived = u.noOfDownvoteReceived
        noOfCommentReactionSent = u.noOfCommentReactionSent
        noOfSavedTag = u.noOfSavedTag
    }
