...
@objcMembers class  UserProfileDBM : Object{
    ...
    dynamic var noOfComment: Int = 0
    dynamic var noOfRoomJoined: Int = 0
    dynamic var noOfHotTakePost: Int = 0
    dynamic var noOfUpvoteGiven: Int = 0
    dynamic var updatedCreatedAt: Int = 0
    dynamic var noOfDownVoteGiven: Int = 0
    dynamic var noOfUpvoteReceived: Int = 0
    dynamic var noOfDownvoteReceived: Int = 0
    dynamic var noOfCommentReactionSent: Int = 0
    dynamic var noOfSavedTag: Int = 0
